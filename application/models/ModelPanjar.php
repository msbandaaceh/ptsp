...
class ModelPanjar extends CI_Model
{
	...
	public function get_seleksi_panjar($no_perkara)
	{
		try {
            $this->db->order_by('ID', 'ASC');
			...
			return $this->db->select('*')->from('v_perkara_biaya')->get()->result();
		} catch (Exception $e) {
			return 0;
		}
	}
	...
	public function get_seleksi_petugas($role_id) {
        try {
